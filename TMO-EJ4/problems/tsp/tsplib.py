...
def read_tsp_data(tsp_name):
    tsp_name = tsp_name
    tsp_name = os.path.join('data/tsplib', tsp_name)
...
if __name__ == '__main__':
    produce_final(file='berlin52.tsp')
